...
enum Effect {NONE, BURN, PARA, SLEEP, PSN, CFN, LOWER_ENEMY_ATK, LOWER_ENEMY_DEF, LOWER_ENEMY_ATKSPE, LOWER_ENEMY_DEFSPE, LOWER_ENEMY_SPEED,
			BOOST_TARGET_ATK, BOOST_TARGET_DEF, BOOST_TARGET_ATKSPE, BOOST_TARGET_DEFSPE, BOOST_TARGET_SPEED, HIGH_CRIT_RATE}
